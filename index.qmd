...
*N = 63,667 county-years. 1,201 counties, 53 years. County and year FE absorbed. Base lynching rate = 2.9%.*

The spatial lag ρ = +0.054 (p < 0.001). A one-unit increase in the spatial lag — all neighbors having lynched in the prior year — raises the lynching probability by 5.4 percentage points, nearly doubling the 2.9% base rate.
...
w_res = pd.DataFrame({
    ...
    "ρ": ["+0.054", "+0.101", "+0.041", "+0.041"],
    "SE": ["(0.013)", "(0.025)", "(0.017)", "(0.020)"],
...
![](figures/fig5_w_comparison.png){fig-alt="Spatial lag ρ by W-matrix specification — newspaper > geographic > railroad ≈ denomination"}

**Newspaper co-coverage produces the largest ρ (0.101, p < 0.001)**, 88% above the geographic adjacency estimate. All four channels are statistically significant with the corrected full-South dataset, but the newspaper network is the dominant transmission mechanism. Railroad and denomination channels, while real, are substantially weaker.
